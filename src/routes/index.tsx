  ...
  const generateExcel = () => {
    ...
    // ============ 1. EXECUTIVE SUMMARY ============
    {
      const rows: (CellSpec | null)[][] = [
        ...
        [{ v: `${client.name}  ·  Prepared ${dateStr}`, s: subtitleStyle }, null, null, null],
        [null, null, null, null],
        [{ v: "ACCOUNT SNAPSHOT", s: sectionStyle }, null, null, null],
        [{ v: "Client", s: labelStyle }, { v: client.name, s: valueStyle() }, { v: "Prepared By", s: labelStyle }, { v: preparedBy, s: valueStyle() }],
        [{ v: "Industry", s: labelStyle }, { v: client.industry, s: valueStyle(true) }, { v: "Region", s: labelStyle }, { v: client.region, s: valueStyle(true) }],
        [{ v: "Services", s: labelStyle }, { v: client.services, s: valueStyle() }, null, null],
        [null, null, null, null],
        [{ v: "Generated by Handover OS", s: footerStyle }, null, null, null],
      ];
            ...
            <div className="flex items-start gap-5">
              ...
              <div>
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[11px] font-medium text-muted-foreground">v2.4</span>
                </div>
